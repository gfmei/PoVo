...
from datasets.SensorData import SensorData # type: ignore
...
# python reader.py --filename /storage/TEV/gmei/data/scannet/scans --output_path /storage2/TEV/datasets/ScanNet